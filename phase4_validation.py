 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    print(f\"  {name}: Temp +{params['temp_change']}°C, \" +\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    'CO2': ['CO2_ppm', 'CO2_Growth_Rate_ppm_per_year'],\n",
    ...
    "    'Location': ['Crop_encoded', 'Zone_encoded', 'State_encoded']\n",
    "}\n",
    "\n",
    "group_importance = {}\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "print(\"  ✓ Performance summaries saved\")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "print(f\"  R²: {validation_report['overall_performance']['r2']:.4f}\")\n",
    "\n",
    "print(\"\\n🗺️ REGIONAL PERFORMANCE:\")\n",
    "print(f\"  Best Zone: {validation_report['best_performing_zone']}\")\n",
    "print(f\"    R²: {zone_performance.loc[validation_report['best_performing_zone'], 'R2']:.4f}\")\n",
    "print(f\"  Worst Zone: {validation_report['worst_performing_zone']}\")\n",
    "print(f\"    R²: {zone_performance.loc[validation_report['worst_performing_zone'], 'R2']:.4f}\")\n",
    "\n",
    "print(\"\\n🌾 CROP-SPECIFIC PERFORMANCE:\")\n",
    "print(f\"  Best Crop: {validation_report['best_performing_crop']}\")\n",
    "print(f\"    R²: {crop_performance.loc[validation_report['best_performing_crop'], 'R2']:.4f}\")\n",
    "print(f\"  Worst Crop: {validation_report['worst_performing_crop']}\")\n",
    "print(f\"    R²: {crop_performance.loc[validation_report['worst_performing_crop'], 'R2']:.4f}\")\n",
    "\n",
    "print(\"\\n🌡️ CLIMATE SCENARIO PROJECTIONS:\")\n",
    "print(f\"  Moderate Warming (+1.5°C, -5% rain): {validation_report['climate_scenario_impacts']['moderate_warming']:.2f}% yield change\")\n",
    "print(f\"  High Warming (+2.0°C, -10% rain): {validation_report['climate_scenario_impacts']['high_warming']:.2f}% yield change\")\n",
    "print(f\"  Extreme Warming (+3.0°C, -15% rain): {validation_report['climate_scenario_impacts']['extreme_warming']:.2f}% yield change\")\n",
    "\n",
    ...
    "    print(\"  ✓ Model shows strong predictive performance (R² > 0.8)\")\n",
    "else:\n",
    "    print(\"  ⚠ Model performance could be improved (R² < 0.8)\")\n",
    "\n",
    "if validation_report['climate_scenario_impacts']['high_warming'] < -5:\n",
    "    print(\"  ⚠ Significant yield losses projected under climate change\")\n",
    "elif validation_report['climate_scenario_impacts']['high_warming'] < 0:\n",
    "    print(\"  → Moderate yield losses projected under climate change\")\n",
    "else:\n",
    "    print(\"  ✓ Yields may be resilient under moderate climate change\")\n",
    "\n",
    "print(\"\\n✅ NEXT STEPS:\")\n",
